...
var _queryCallback = R.curry(function(deferred, connection, singleReturnItem, allowEmptyResponse, err, data) {
  ...
  if (isNilOrEmpty(data)) {
    ...
    if (allowEmptyResponse) {
      return deferred.resolve(singleReturnItem ? undefined : [])
    } else {
